  var _maze, _vue;
            _vue = new Vue({
                ...
                computed: {
                    finished: function() {
                        return this.maze.finish ? this.maze.position[0] == this.maze.finish[0] && this.maze.position[1] == this.maze.finish[1] : false;
                    },
                    direction: function() {
                        return this.maze.finish ? this.maze.rotation + 180 - (Math.atan2(this.maze.finish[0] - this.maze.position[0], this.maze.finish[1] - this.maze.position[1]) * 180 / Math.PI) % 360 : 0
                    },
